...
public class ManageUsers extends javax.swing.JFrame {
    ...
    public ManageUsers() {
        ...
        setSize(630, 330);
        setResizable(false);
        setTitle("Registered Users - Session as " + user);
        ...
        try {
            ...
            PreparedStatement pst = cn.prepareStatement(
                    "SELECT id_user, user_name, username, type_level, status FROM users"
            );
            ...
            JOptionPane.showMessageDialog(null, "Error showing information, Contact with admin.");
        }
        
        jTable_users.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                int row_point = jTable_users.rowAtPoint(e.getPoint());
                int column_point = 2;
